...
public class MiniJavaParser implements MiniJavaParserConstants {
  ...
  static final public ImportFunction ImportFunction() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
   ...
   Token n5;
    ...
    n5 = jj_consume_token(SEMICOLON);
     ...
     {if (true) return new ImportFunction(n0,n2,n4);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public LambdaType LambdaType() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
   ...
   Token n9;
    ...
    n9 = jj_consume_token(GT);
            n8 = JTBToolkit.makeNodeToken(n9);
     {if (true) return new LambdaType(n0,n2,n4,n5,n7,n8);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public LambdaExpression LambdaExpression() throws ParseException {
   NodeToken n0;
   Token n1;
   Identifier n2;
   NodeToken n3;
   ...
   Expression n7;
    ...
    n6 = jj_consume_token(ARROW);
             n5 = JTBToolkit.makeNodeToken(n6);
    n7 = Expression();
     {if (true) return new LambdaExpression(n0,n2,n3,n5,n7);}
    throw new Error("Missing return statement in function");
  }
